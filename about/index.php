...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
     <title>About us - Switchboo</title>
...
<body>
   ...
   <?php include_once('../includes/navbar.php'); ?>
    ...
    <div class="container-fluid pink-bg" id="section-one-container">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="title">A service that does it all for you</h2>
            </div>
        </div>
    </div>


    <div class="container-fluid" id="section-two-container">

        <div class="row step-container">
            <div class="col-10 offset-1 col-md-6 offset-md-3 step-box">
                <h2>Who are we?</h2>
                <p>We got fed up seeing over half of the UK overpaying on their energy bills, just because they didn't have time to search for a better deal. So we created Switchboo to take care of the switching for you.</p>  
            </div>
        </div>
        ...
        <div class="row step-container">
            <div class="col-10 offset-1 col-md-6 offset-md-3 step-box">
                <h2>Our mission</h2>
                <p>We are on a mission to get every household a great energy deal and stop consumers from overpaying.</p>  
            </div>
        </div>
    ...
    <?php include_once('../includes/lower-action.php'); ?>
...
<?php include_once('../includes/form-fix.php'); ?>